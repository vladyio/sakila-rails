customer_copy_values = <<~SQL
  ALTER TABLE customers DISABLE TRIGGER ALL;
  INSERT INTO customers (id, store_id, first_name, last_name, email, address_id,
...
ActiveRecord::Base.connection.execute(customer_copy_values)
