...
ActiveRecord::Schema[7.0].define(version: 2023_05_02_100931) do
  ...
  create_table "films", force: :cascade do |t|
    ...
    t.bigint "original_language_id_id"
    t.index ["language_id"], name: "index_films_on_language_id"
    t.index ["original_language_id_id"], name: "index_films_on_original_language_id_id"
  end
  ...
  add_foreign_key "films", "languages", column: "original_language_id_id"
